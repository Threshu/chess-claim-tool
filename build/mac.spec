...
a = Analysis(['../main.py'],
             pathex=[path],
             binaries=[],
             datas=[("../icons/error_icon.png","."),("../icons/add_icon.png","."),("../icons/delete_icon.png","."),("../icons/spinner.gif","."),("../icons/check_icon.png","."),("../icons/logo.png","."),("../main.css","."),("../ntfy_config.json",".")],
             hiddenimports=["ntfy_notifier"],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
